...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        private static void AlertPersonToNewRound(PersonModel person, string teamName, MatchupEntryModel competitor)
        {
            ...
            fromAddress = GlobalConfig.AppKeyLookup("emailSender");
        ...
        {
            foreach (MatchupModel matchup in model)
            {
        ...
        private static void MarkWinnersInMatchups(List<MatchupModel> model)
        {
            //1 - true / 0 - false or low score wins
